...
int main(int argc, char *argv[])
{
	if (argc < 3) {
		...
		//                       0 1  2   3
		"nproc tau lambda zfini theta nscales zfactor nwarps epsilon "
    ...
    float zfini   = (argc>i)? atof(argv[i]): PAR_DEFAULT_ZFINI;  i++;
